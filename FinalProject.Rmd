...
interaction_model <- lm(census2020$num_arrests ~ census2020$num_subway + census2020$pop + census2020$num_parks + census2020$num_historic + census2020$num_wifi + census2020$num_museum + census2020$POPS_true + census2020$num_subway*census2020$POPS_true,  census2020)
...
```{r}
interact_plot(interaction_model, pred = census2020$num_subway, modx = census2020$POPS_true,
              interval = TRUE) +
