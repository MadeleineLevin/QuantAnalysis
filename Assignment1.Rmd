...
coeff_names_interaction <- c("Constant" = "(Intercept)",
                 ...
                 "Population density" = "census2020$pop",
...
interaction_model <- lm(census2020$allarrestssummer ~ census2020$num_subway + census2020$pop + census2020$num_parks + census2020$num_historic + census2020$num_wifi + census2020$num_museum + num_wifi*num_historic, centered_data)

export_summs(centered_data, interaction_model,
             error_format = "(p = {p.value})",
             error_pos = "same",
